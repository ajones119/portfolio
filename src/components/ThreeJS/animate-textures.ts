...
import Checkerboard1024 from "../../assets/images/demoImages/threejs/textures/checkerboard-1024x1024.png"
import Checkerboard8 from "../../assets/images/demoImages/threejs/textures/checkerboard-8x8.png"
import Minecraft from "../../assets/images/demoImages/threejs/textures/minecraft.png"
...
const textureColor = textureLoader.load(Minecraft.src);
textureColor.colorSpace = THREE.SRGBColorSpace
/*
textureColor.repeat = new THREE.Vector2(1, 1);
textureColor.wrapS = THREE.RepeatWrapping;
textureColor.wrapT = THREE.RepeatWrapping;
textureColor.offset = new THREE.Vector2(0.5, 0.5)
*/

//rotate into the center
// textureColor.rotation = Math.PI / 4;
// textureColor.center = new THREE.Vector2(0.5, 0.5);
...
const textureAlpha = textureLoader.load(DoorAlpha.src);
const textureAmbient = textureLoader.load(DoorAmbient.src);
const textureNormal = textureLoader.load(DoorNormal.src);
const textureHeight = textureLoader.load(DoorHeight.src);
const textureMetalness = textureLoader.load(DoorMetalness.src);
const textureRoughness = textureLoader.load(DoorRoughness.src);
...
const material = new THREE.MeshBasicMaterial({ wireframe: false, map: textureColor });
